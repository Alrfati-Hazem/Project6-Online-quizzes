                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="{{route("manage-question.store")}}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="option1" id="option1" cols="30" rows="5" class="form-control">{{old("option1")}}</textarea>
                                                @error('option1')
                                                    <strong class="error">{{$message}}</strong>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea name="option2" id="option2" cols="30" rows="5" class="form-control">{{old("option2")}}</textarea>
                                                @error('option2')
                                                    <strong class="error">{{$message}}</strong>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea name="option3" id="option3" cols="30" rows="5" class="form-control">{{old("option3")}}</textarea>
                                                @error('option3')
                                                    <strong class="error">{{$message}}</strong>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea name="option4" id="option4" cols="30" rows="5" class="form-control">{{old("option4")}}</textarea>
                                                @error('option4')
                                                    <strong class="error">{{$message}}</strong>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <textarea name="correct_answer" id="correct_answer" cols="30" rows="5" class="form-control">{{old("correct_answer")}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="point" name="point" type="number" class="form-control" value="{{old("point")}}">
                                                @error('point')
                                                    <strong class="error">{{$message}}</strong>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                 ...
                                                 <div class="input-group">
                                                    <select name="exam_id" id="exam_id" value="{{old("exam_id")}}" class="form-control">
