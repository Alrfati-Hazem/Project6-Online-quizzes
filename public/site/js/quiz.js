...
// // let numberOfPage
// // if (localStorage.getItem('quizNumber') == 1) {
...
// //       pageQuestion = loadhtmlQuestions
// //       numberOfPage = 1
// //       console.log(pageQuestion)
// //     })
// // } else if (localStorage.getItem('quizNumber') == 2) {
...
// //       numberOfPage = 2
// //     })
// // } else if (localStorage.getItem('quizNumber') == 3) {
...
//   if (que_count < pageQuestion.length - 1) {
...
//   let que_tag =
//     '<span>' +
//     pageQuestion[index].numb +
//     '. ' +
//     pageQuestion[index].question +
//     '</span>'
//   let option_tag =
//     '<div class="option"><span>' +
//     pageQuestion[index].options[0] +
//     '</span></div>' +
//     '<div class="option"><span>' +
//     pageQuestion[index].options[1] +
//     '</span></div>' +
//     '<div class="option"><span>' +
//     pageQuestion[index].options[2] +
//     '</span></div>' +
//     '<div class="option"><span>' +
//     pageQuestion[index].options[3] +
//     '</span></div>'
...
//   let correcAns = pageQuestion[que_count].answer
...
//   localStorage.setItem('page', numberOfPage)
//   window.open('../html/answer.html', '_self')
// }
